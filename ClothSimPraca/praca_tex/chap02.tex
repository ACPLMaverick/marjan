...
\label{t:teoria}
	...
	\label{t:teoria:analiza}
		...
		\label{t:teoria:analiza:poz}
			...
			\myfigure{Rysunek 2.3}{figures/pic_2_3.png}{0.3}{}
		...
		\label{t:teoria:analiza:kolizje}
			...
			\label{t:teoria:analiza:kolizje:zewn}
				...
				%\myfigure{Rysunek 2.4}{figures/pic_2_4.png}{0.4}{}		%R1, R2, d
				...
				%\myfigure{Rysunek 2.5}{figures/pic_2_5.png}{0.4}{}		%dwa boksy p1min, p1max, p2min, p2max
			...
			\label{t:teoria:analiza:kolizje:wewn}
				...
				%\myfigure{Rysunek 2.6}{figures/pic_2_6.png}{0.4}{}		% schemat sfer kolizyjnych dla siatki
	...
	\label{t:teoria:gpu}
		...
		%\myfigure{Rysunek 2.7}{figures/pic_2_7.png}{0.4}{}		% schemat GPU
		...
		%\myfigure{Rysunek 2.8}{figures/pic_2_8.png}{0.4}{}		% schemat gridu CUDA'owego
		...
		%\myfigure{Rysunek 2.9}{figures/pic_2_9.png}{0.4}{}		% jak to działa w api graficznym
		...
		%\myfigure{Rysunek 2.10}{figures/pic_2_10.png}{0.4}{}		% proste schematy GPU i CPU obok
		
		
		
		%\myfigure{Rysunek 2.11}{figures/pic_2_11.png}{0.4}{}		% 2 wykresy - przewaga GPU nad CPU w danych obliczeniach i odwrotnie
		
		\subsection{Zastosowanie GPU w symulacji tkanin}
		\label{t:teoria:gpu:zalety}
		
		%\myfigure{Rysunek 2.12}{figures/pic_2_12.png}{0.4}{}		% wykres - porównanie GPU i CPU dla tkanin
