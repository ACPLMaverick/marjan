...
{
	//Put the vertex and index buffer on the graphics pipeline to prepare them for drawing
...
bool ModelClass::InitializeBuffers(ID3D11Device* device) /*Where we handle creating the vertex and index buffers.*/
{
	VertexType* vertices;
