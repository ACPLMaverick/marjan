...
bool LightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../DirectXEngine/lightVS.hlsl", L"../DirectXEngine/lightPS.hlsl");
	if (!result)
	{
		return false;
	}
...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	//Compile the light vertex shader code
	...
	//Compile the light pixel shader code
	...
	//Release the vertex shader buffer and pixel shader buffer since they are not longer needed
	...
	//Setup the desctiption of the dunamic matrix constant buffer that is in the vertex shader
	...
	//Note that ByteWidth always needs to be a multiple of 16 if using D3D11_BIND_CONSTANT_BUFFER or CreateBufer will fail
	...
	ID3D11ShaderResourceView* texture, D3DXVECTOR3 lightDirection, D3DXVECTOR4 diffuseColor)
{
	...
	//Copy the ligthing variables into the constant buffer
